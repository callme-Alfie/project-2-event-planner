...
function BFooter() {
    return (
        <div>
            ...
            <div className="Bstraight-line"></div>
            <span className="Bcopyright">Copyright 2020 Alfie Code Lab. All Rightd Reserved.</span>
            <span className="Bprivacy">Privacy | Terms of Use | Cookie Policy</span>
        </div>
    );
}
