...
function CFooter() {
    return (
        <div>
            ...
            <div className="Cstraight-line"></div>
            <span className="Ccopyright">Copyright 2020 Alfie Code Lab. All Rightd Reserved.</span>
            <span className="Cprivacy">Privacy | Terms of Use | Cookie Policy</span>
        </div>
    );
}
