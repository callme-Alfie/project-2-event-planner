...
const Slide1 = () => {
  ...
  return (
    <div className="content1">
      ...
      <animated.span style={slideFromTop} className="get-ready1">
        Get Ready to Travel <br /> The World.
      </animated.span>

      {/* Animated div for travel-world-div1 */}
      <animated.div style={slideFromTop} className="travel-world-div1"></animated.div>
      ...
      <div className="image-div1">
        <img
          src="https://html.geekcodelab.com/holiday-planners/assets/images/banner-slide-3.jpg"
          alt="Italy Mountains"
