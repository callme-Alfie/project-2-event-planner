...
const Slide2 = () => {
  ...
  return (
    <div className="content1">
      ...
      <animated.span style={slideFromTop} className="get-ready2">
        Enjoy the Travels with <br /> Holiday Planners.
      </animated.span>

      {/* Animated div for travel-world-div1 */}
      <animated.div style={slideFromTop} className="travel-world-div2"></animated.div>
      ...
      <div className="image-div1">
        <img
          src="https://html.geekcodelab.com/holiday-planners/assets/images/banner-slide-1.jpg"
          alt="Italy Mountains"
